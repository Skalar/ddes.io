...
// hexo.extend.helper.register('apiClassLink', function (package, className) {
//   const sanitizedPackage = package.toLowerCase().replace(/[^a-z]/g, '_')
//   const sanitizedClass = className.toLowerCase()
//   return `https://s3-eu-west-1.amazonaws.com/ddes-docs/latest/classes/${sanitizedPackage}.${sanitizedClass}.html`
// })

hexo.extend.helper.register('raw_link', function(path) {
  return 'https://github.com/Skalar/ddes.io/edit/master/source/' + path
})
